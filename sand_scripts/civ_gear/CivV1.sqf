...
_Veh1 = [getMarkerPos _marker, 0, "C_Hatchback_01_F", _Civ1] call BIS_fnc_spawnVehicle;
[_Civ1, getmarkerpos _marker, 3000] call BIS_fnc_taskPatrol;
Sleep 15;

_Veh2 = [getMarkerPos _marker, 0, "C_Hatchback_01_F", _Civ2] call BIS_fnc_spawnVehicle;
[_Civ2, getmarkerpos _marker, 3000] call BIS_fnc_taskPatrol;
Sleep 15;

_Veh3 = [getMarkerPos _marker, 0, "C_Hatchback_01_F", _Civ3] call BIS_fnc_spawnVehicle;
