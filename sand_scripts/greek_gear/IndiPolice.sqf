...
_WP = _IndiGroup1 addWaypoint [getmarkerpos _marker1, 0]; _WP setWaypointType "LOITER"; _WP setWaypointBehaviour "SAFE";
_WP = _IndiGroup2 addWaypoint [getmarkerpos _marker2, 0]; _WP setWaypointType "LOITER"; _WP setWaypointBehaviour "SAFE";
Sleep 5;
